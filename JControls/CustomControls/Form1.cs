using CustomControls.JControls;
...
namespace CustomControls
{
    public partial class Form1 : Form
    {
        ...
        private void Open_DropdownMenu(JDropdownMenu dropdownMenu, object sender)
        {
        ...
        private void Open_DropdownMenu2(JDropdownMenu dropdownMenu, object sender)
        {
            Control control = (Control)sender;
            dropdownMenu.VisibleChanged += new EventHandler((sender2, ev)
              => DropdownMenu_VisibleChanged(sender2, ev, control));
        ...
        {
            JDropdownMenu dropdownMenu = (JDropdownMenu)sender;
            if (!DesignMode)
            {
